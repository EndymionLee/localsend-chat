...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static bool _$sharedClipboard(SettingsState v) => v.sharedClipboard;
  static const Field<SettingsState, bool> _f$sharedClipboard = Field(
    'sharedClipboard',
    _$sharedClipboard,
  );
  ...
  final MappableFields<SettingsState> fields = const {
    ...
    #sharedClipboard: _f$sharedClipboard,
  };
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
      ...
      sharedClipboard: data.dec(_f$sharedClipboard),
    );
  }
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (sharedClipboard != null) #sharedClipboard: sharedClipboard,
    }),
  );
  @override
  SettingsState $make(CopyWithData data) => SettingsState(
    ...
    sharedClipboard: data.get(#sharedClipboard, or: $value.sharedClipboard),
  );
